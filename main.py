...
app.add_middleware(
       CORSMiddleware,
       allow_origins=["https://nocode-saurabh.github.io",  # Base domain
        "https://nocode-saurabh.github.io/factopedia-web",  # Your specific app path
        "http://localhost:3000",]  # Local development],  # React app's origin
